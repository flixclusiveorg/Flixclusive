...
class GetHomeHeaderUseCaseImplTest {
    ...
    @Test
    fun `should return success with movie metadata when popular movie is found`() = runTest {
    ...
    @Test
    fun `should return success with tv show metadata when popular tv show is found`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
    ...
    @Test
    fun `should skip unpopular movies with low vote count`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
    ...
    @Test
    fun `should return failure when no suitable header item is found after max retries`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
        val unpopularMovie = FilmTestDefaults.getFilmSearchItem(
    ...
    @Test
    fun `should handle empty search results gracefully`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
    ...
    @Test
    fun `should handle failed search requests gracefully`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
    ...
    @Test
    fun `should handle metadata fetch failure gracefully`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
        val popularMovie = FilmTestDefaults.getFilmSearchItem(
    ...
    @Test
    fun `should handle film without tmdb id gracefully`() = runTest {
        val mockCatalog = mockk<TMDBDiscoverCatalog> {
            coEvery { url } returns "test-url"
        }
