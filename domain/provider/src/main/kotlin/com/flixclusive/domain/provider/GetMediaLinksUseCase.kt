...
import com.flixclusive.domain.provider.util.CachedLinksHelper
import com.flixclusive.domain.provider.util.EMPTY_PROVIDER_MESSAGE
import com.flixclusive.domain.provider.util.MediaLinksExtractor
...
class GetMediaLinksUseCase
    ...
    constructor(
        ...
        private suspend fun resolveEpisodeIfNeeded(
            ...
            val nextEpisode = tmdbHelper.getNearestEpisodeToWatch(film as TvShow, watchHistoryItem)
