...
import com.flixclusive.domain.provider.testing.model.TestStatus.FAILURE
import com.flixclusive.domain.provider.testing.model.TestStatus.NOT_IMPLEMENTED
import com.flixclusive.domain.provider.testing.model.TestStatus.RUNNING
 ...
 * @see TestStatus
 * */
data class ProviderTestCaseResult(
