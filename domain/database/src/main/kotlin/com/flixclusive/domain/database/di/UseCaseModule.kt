...
internal abstract class UseCaseModule {
    @Binds
    abstract fun bindSetWatchProgressUseCase(impl: SetWatchProgressUseCaseImpl): SetWatchProgressUseCase

    @Binds
    abstract fun bindToggleWatchlistStatusUseCase(impl: ToggleWatchlistStatusUseCaseImpl): ToggleWatchlistStatusUseCase
}
