...
internal class SetWatchProgressUseCaseImpl @Inject constructor(
    private val watchProgressRepository: WatchProgressRepository,
) : SetWatchProgressUseCase {
    override suspend fun invoke(watchProgress: WatchProgress, media: MediaMetadata?): Long {
        if (watchProgress.isLessThanAMinute()) {
            return -1
        }

        return watchProgressRepository.insert(watchProgress, media)
    }
}
