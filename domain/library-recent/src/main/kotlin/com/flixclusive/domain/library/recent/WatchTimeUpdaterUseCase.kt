package com.flixclusive.domain.library.recent
        ...
        suspend operator fun invoke(
            ...
            if (isTvShow) {
                ...
                if (isEpisodeWatchedAlready) {
                    ...
                    updatedEpisodesWatchedList[episodeWatchedIndex] =
                        episode.copy(
