...
import com.flixclusive.domain.updater.model.catalog.SearchCatalog
        ...
        operator fun invoke() {
            ...
            initializationJob =
                AppDispatchers.Default.scope.launch {
                    ...
                    configurationManager.searchCatalogsData?.run {
                        val defaultErrorMessage = Resource.Failure(R.string.failed_to_initialize_search_items)
                    ...
                    } ?: _cards.emit(Resource.Failure(error = UiText.StringResource(R.string.failed_to_init_app)))
                }
        }
    }
