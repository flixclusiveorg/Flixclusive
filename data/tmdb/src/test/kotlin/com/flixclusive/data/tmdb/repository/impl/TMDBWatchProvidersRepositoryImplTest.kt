...
class TMDBWatchProvidersRepositoryImplTest {
    ...
    @Test
    fun `getWatchProviders returns success with real streaming data for popular movie`() =
    ...
    @Test
    fun `getWatchProviders returns success with real streaming data for popular TV show`() =
        runTest(testDispatcher) {
            val mediaType = "tv"
    ...
    @Test
    fun `getWatchProviders handles Disney movie with multiple providers`() =
        runTest(testDispatcher) {
            val mediaType = "movie"
    ...
    @Test
    fun `getWatchProviders handles Netflix original series`() =
        runTest(testDispatcher) {
            val mediaType = "tv"
    ...
    @Test
    fun `getWatchProviders throws exception for invalid media type`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `getWatchProviders accepts valid media types movie and tv`() =
        runTest(testDispatcher) {
            val movieId = 550
            val tvId = 1399
            ...
            expectThat(movieResult).isSuccess()
            expectThat(tvResult).isSuccess()
        }

    @Test
    fun `getWatchProviders handles recent blockbuster movie`() =
        runTest(testDispatcher) {
            val mediaType = "movie"
