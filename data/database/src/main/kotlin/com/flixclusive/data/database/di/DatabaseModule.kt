...
import com.flixclusive.data.database.repository.impl.WatchHistoryRepositoryImpl
...
internal abstract class DatabaseModule {
    ...
    internal abstract fun bindsWatchHistoryRepository(
        watchHistoryRepository: WatchHistoryRepositoryImpl,
    ...
    ): com.flixclusive.data.database.datasource.LibraryListDataSource
}
