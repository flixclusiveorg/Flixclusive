...
interface WatchHistoryRepository {
    ...
    suspend fun getWatchHistoryItemById(itemId: String, ownerId: Int = 1): WatchHistoryItem?

    fun getWatchHistoryItemByIdInFlow(itemId: String, ownerId: Int = 1): Flow<WatchHistoryItem?>
    ...
    suspend fun deleteById(itemId: String, ownerId: Int = 1)
}