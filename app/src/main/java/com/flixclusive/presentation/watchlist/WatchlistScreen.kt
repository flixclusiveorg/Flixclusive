...
import com.flixclusive.presentation.destinations.WatchlistScreenContentDestination
...
@RootNavGraph
@NavGraph
annotation class WatchlistNavGraph(
    val start: Boolean = false
)

@OptIn(ExperimentalMaterialNavigationApi::class, ExperimentalAnimationApi::class)
@com.ramcosta.composedestinations.annotation.Destination(
    style = WatchlistScreenTransition::class
)
@Composable
fun WatchlistScreen(
    ...
    val startDestination = WatchlistScreenContentDestination
    val navGraph = NavGraphs.watchlist
    ...
    OnSeeMoreDetailsClickObserver(
        ...
        navigate = {
            ...
            navController.navigate(
                WatchlistFilmScreenDestination(mainUiState.longClickedFilm!!)
            )
