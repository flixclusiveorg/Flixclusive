...
import static com.flixclusive.common.Constants.FLIXCLUSIVE_LOG_TAG;
...
/**
 * Based on: <a href="https://github.com/recloudstream/cloudstream/blob/master/app/src/main/java/com/lagradost/cloudstream3/ui/player/NonFinalTextRenderer.java">Custom Renderer</a>
 * <br>
 * Issue: <a href="https://github.com/google/ExoPlayer/issues/854#issuecomment-599237344">Allow applications to modify subtitle offsets during playback #854</a>
 * <br><br>
 * A renderer for text.
 *
    ...
    private void invokeUpdateOutputInternal(List<Cue> cues) {
        ...
        List<Cue> fixedCues = cues.stream().map(
                cue -> {
                    ...
                    if (cue.line == -1F) {
                        builder.setLine(DIMEN_UNSET, LINE_TYPE_NUMBER);
                    }
