package com.flixclusive.presentation.mobile.screens.splash_screen.dialog
...
@Composable
fun ErrorMobileDialog(
    title: String,
    description: String,
    dismissButtonLabel: String = stringResource(R.string.exit_label),
    onDismiss: () -> Unit,
) {
