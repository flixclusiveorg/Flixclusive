...
fun PlayerBufferSize(
    ...
    val sizesList = remember {
        listOf(
            DefaultLoadControl.DEFAULT_TARGET_BUFFER_BYTES.toLong(), 10, 20, 30, 40, 50, 60, 70, 80, 90,
    ...
    BaseSettingsDialog(
        title = stringResource(id = R.string.video_buffer_size),
        ...
        LazyColumn(
            ...
            items(sizesList) {
                ...
                Row(
                    ...
                    Text(
                        text = if(it == DefaultLoadControl.DEFAULT_TARGET_BUFFER_BYTES.toLong()) "Auto" else "${it}MB",
