package com.flixclusive.providers.extractors.mixdrop.utils

/**
 *
 * Source (Aniyomi):
 * https://github.com/aniyomiorg/aniyomi-extensions/blob/master/lib/unpacker/src/main/java/eu/kanade/tachiyomi/lib/unpacker/Unpacker.kt
 *
 *
 */
object Unpacker {
     ...
     * Note: single quotes `\'` in the data will be replaced with double quotes `"`.
     */
    private fun unpack(script: SubstringExtractor, left: String? = null, right: String? = null): String {
        val packed = script
