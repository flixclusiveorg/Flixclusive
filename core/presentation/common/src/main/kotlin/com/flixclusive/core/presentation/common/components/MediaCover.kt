...
/**
 * Enum representing different types of media covers with their respective aspect ratios.
 *
 * - [Backdrop]: Typically has an aspect ratio of 16:9.
 * - [Poster]: Typically has an aspect ratio of 2:3.
 *
 * @property ratio The aspect ratio of the media cover.
 * */
enum class MediaCover(
    val ratio: Float,
) {
    ...
    /**
     * Composable that displays a media cover image (poster or backdrop) with a placeholder.
     *
     * @param imagePath The path to the image to be loaded.
     * @param title The title of the media, used for the placeholder.
