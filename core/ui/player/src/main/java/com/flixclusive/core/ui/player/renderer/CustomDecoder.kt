...
internal class CustomSubtitleDecoderFactory : SubtitleDecoderFactory {
...
//    }
    ...
    override fun createDecoder(format: Format): SubtitleDecoder {
        ...
        return DelegatingSubtitleDecoder(
            parser::class.simpleName + "Decoder",
            parser,
        )
    }
}
...
//private class OutlineSpan(@Px val outlineWidth : Float) : CharacterStyle() {
