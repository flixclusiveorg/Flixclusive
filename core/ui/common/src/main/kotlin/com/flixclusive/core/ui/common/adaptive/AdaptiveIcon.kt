package com.flixclusive.core.ui.common.adaptive
...
private fun Modifier.defaultSizeFor(
    ...
    this.then(
        if (painter.hasNoValidSize() || compact != null) {
...
private fun Size.isInfinite()
    = width.isInfinite() && height.isInfinite()
private fun Painter.hasNoValidSize()
    = intrinsicSize == Size.Unspecified || intrinsicSize.isInfinite()
