...
import com.flixclusive.core.common.provider.MediaLinkResourceState.Error
import com.flixclusive.core.common.provider.MediaLinkResourceState.Extracting
import com.flixclusive.core.common.provider.MediaLinkResourceState.Fetching
import com.flixclusive.core.common.provider.MediaLinkResourceState.Idle
import com.flixclusive.core.common.provider.MediaLinkResourceState.Success
import com.flixclusive.core.common.provider.MediaLinkResourceState.Unavailable
 ...
 * @see MediaLink
 */
sealed class MediaLinkResourceState(
    val message: UiText,
) {
    ...
    class Error(
        ...
        constructor(error: Throwable?) : this(
            if (error?.localizedMessage == null) {
                ...
                UiText.StringValue(error.localizedMessage!!)
            },
        )
    }
     ...
     */
    data object Success :
        MediaLinkResourceState(message = UiText.StringResource(R.string.source_data_dialog_state_success)) {
    ...
    data object SuccessWithTrustedProviders : MediaLinkResourceState(
        message = UiText.StringResource(R.string.source_data_dialog_state_success_with_trusted_providers),
    ) {
