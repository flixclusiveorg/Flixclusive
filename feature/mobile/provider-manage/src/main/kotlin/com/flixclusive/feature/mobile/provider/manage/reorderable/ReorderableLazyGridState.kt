 ...
 */
@Composable
internal fun rememberReorderableLazyGridState(
    ...
    scroller: Scroller = rememberScroller(
        ...
        pixelAmountProvider = { lazyGridState.layoutInfo.mainAxisViewportSize * SCROLL_AMOUNT_MULTIPLIER },
    ),
...
private fun LazyGridState.toLazyCollectionState() =
    object : LazyCollectionState<LazyGridItemInfo> {
        ...
        override suspend fun animateScrollBy(
            value: Float,
            animationSpec: AnimationSpec<Float>,
        ) = this@toLazyCollectionState.animateScrollBy(value, animationSpec)

        override suspend fun requestScrollToItem(
            index: Int,
            scrollOffset: Int,
...
@Stable
internal class ReorderableLazyGridState(
    state: LazyGridState,
 ...
 */
@Composable
internal fun LazyGridItemScope.ReorderableItem(
