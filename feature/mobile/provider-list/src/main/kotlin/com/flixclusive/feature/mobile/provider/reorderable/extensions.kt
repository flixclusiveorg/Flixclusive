...
internal fun Size.getAxis(orientation: Orientation) =
    when (orientation) {
...
internal fun Offset.Companion.fromAxis(
...
internal fun IntSize.Companion.fromAxis(
    orientation: Orientation,
    value: Float,
) = when (orientation) {
...
internal fun IntOffset.Companion.fromAxis(
    orientation: Orientation,
    value: Int,
) = when (orientation) {
