...
internal object CustomSliderDefaults {
    ...
    fun colors(
        ...
        inactiveTickColor: Color = SliderTokens.TickMarksInactiveContainerColor
            .toColor()
        ...
        disabledInactiveTickColor: Color = SliderTokens.TickMarksDisabledContainerColor
            .toColor()
            .copy(alpha = SliderTokens.TickMarksDisabledContainerOpacity),
    ): CustomSliderColors =
        CustomSliderColors(
    ...
    fun Track(
        ...
        Canvas(
            ...
            customSliderPositions.tickFractions
                .groupBy {
